...
public class TextViewFontSansProBoldColorSplit extends TextView {
    ...
    public TextViewFontSansProBoldColorSplit(Context context, AttributeSet attrs) {
        super(context, attrs);
        Typeface type = Typeface.createFromAsset(context.getAssets(),"fonts/SourceSansPro-Bold.otf");
        this.setTypeface(type);
       this.setTextColor(context.getResources().getColor(R.color.split_bg));
    ...
    public TextViewFontSansProBoldColorSplit(Context context, AttributeSet attrs, int defStyleAttr) {
