...
public class CCPCountry implements Comparable<CCPCountry> {
    ...
    boolean isEligibleForQuery(String query) {
        Log.e("eligwuerygetName",getName());
        Log.e("eligwuerygetNameCode",getNameCode());
        Log.e("eligwuerygetPhoneCode",getPhoneCode());
        //Log.e("eligwuerygetEnglishName",getEnglishName());
        query = query.toLowerCase();
        return getName().toLowerCase().contains(query) || getNameCode().toLowerCase().contains(query) ||
                getPhoneCode().toLowerCase().contains(query);
        /*return getName().toLowerCase().contains(query) || getNameCode().toLowerCase().contains(query) ||
                getPhoneCode().toLowerCase().contains(query) || getEnglishName().toLowerCase().contains(query);*/
    }
