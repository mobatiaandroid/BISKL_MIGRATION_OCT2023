...
/*      if (commentthree.getText().toString().trim().equals("")) {
    ...
    override fun getItemViewType(position: Int): Int {
        return dataSet[position].getViewType().toInt()
...
//        }
    ...
    override fun onBindViewHolder(holder: ViewHolder?, listPosition: Int) {
        val `object`: StudentModel = dataSet[listPosition]
        if (`object` != null) {
            when (`object`.getViewType().toInt()) {
                StudentModel.VIEW_TYPE1 -> {
                    (holder as PresentType1ViewHolder?)!!.textViewStudentName.setText(`object`.getmName())
                    holder!!.registrationcomment.setText(`object`.getRegistrationComment())
                    holder!!.textViewStudentYear.setText(`object`.getmClass() + " " + `object`.getmSection())
                    holder!!.textViewAMRegisterValue.setText(`object`.getAbRegister())
                    ...
                    if (!`object`.getmPhoto().equals("")) {
                        Picasso.with(mContext).load(AppUtils.replace(`object`.getmPhoto()))
...
//                    }
                ...
                StudentModel.VIEW_TYPE2 -> {
                    (holder as ReportType2ViewHolder?)!!.textViewStudentName.setText(`object`.getmName())
                    holder!!.commentvalue.setText(`object`.getRegistrationComment())
                    holder!!.textViewStudentYear.setText(`object`.getmClass() + " " + `object`.getmSection())
                    holder!!.textViewAMRegisterValue.setText(`object`.getAbRegister())
                    holder!!.textViewLastUpdatedValue.setText(
                        AppUtils.dateParsingToDdMmmYyyy(
                    ...
                    if (`object`.getStatus().equalsIgnoreCase("1")) {
                        ...
                        if (`object`.getParent_id()
                                .equalsIgnoreCase(PreferenceManager.getUserId(mContext))
                        ) {
                            holder!!.textViewReportedTime.text =
                                "REPORTED BY YOU AT : " + AppUtils.dateParsingToTime(`object`.getApp_updated_on())
                        } else {
                            holder!!.textViewReportedTime.text =
                                "REPORTED BY " + `object`.getParent_name()
                                    .toString() + " AT : " + AppUtils.dateParsingToTime(`object`.getApp_updated_on())
                        }
...
//                    }
                ...
                StudentModel.VIEW_TYPE3 -> {
                    (holder as ReportedType3ViewHolder?)!!.textViewStudentName.setText(`object`.getmName())
                    holder!!.commentthree.setText(`object`.getRegistrationComment())
                    holder!!.textViewStudentYear.setText(`object`.getmClass() + " " + `object`.getmSection())
                    holder!!.textViewAMRegisterValue.setText(`object`.getAbRegister())
                    holder!!.textViewLastUpdatedValue.setText(
                        AppUtils.dateParsingToDdMmmYyyy(
