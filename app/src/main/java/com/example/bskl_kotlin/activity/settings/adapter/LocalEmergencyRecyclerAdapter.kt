...
class LocalEmergencyRecyclerAdapter(
    var mContext: Context, var mRelationshipModel:ArrayList<LocalEmergencyModel>
) :

    RecyclerView.Adapter<LocalEmergencyRecyclerAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (mRelationshipModel[position].emial.equals("")) {
            ...
            if (mRelationshipModel[position].emial.equals("No Data")) {
                holder.emailValueTextView.setTextColor(mContext.resources.getColor(R.color.red))
            } else {
        ...
        if (mRelationshipModel[position].contactNumber.equals("")) {
            ...
            if (mRelationshipModel[position].contactNumber.equals("No Data")) {
                holder.phoneValueTextView.setTextColor(mContext.resources.getColor(R.color.red))
            } else {
